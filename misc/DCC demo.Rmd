...
max_num_rb = Inf ## Maximum number of rebalances
```
...
```{r chunk11, echo=FALSE, results=FALSE, message=FALSE}
library(tsbs)
library(quantmod)
```


```{r chunk11a, echo=FALSE} 
## =============================================================================
...
strategies <- list(
  ...
  "Ris <-  Parity" = risk_parity_portfolio,
...
```{r chunk12a, echo=FALSE, results='hide', message=FALSE, warning=FALSE}
set.seed(42)
