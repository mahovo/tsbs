...
# Investigate Test 12b 

This examines the diagnostics of Test 12 "EM algorithm achieves tolerance-based convergence" in test-ms_varma_garch_bs.R
...
kable(head(alpha_traj, 5), digits = 2, caption = "alpha trajectory") %>%
...
kable(head(beta_traj, 5), digits = 2, caption = "beta trajectory") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE)
```
...
kable(head(omega_traj, 5), digits = 2, caption = "omgega trajectory") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE)
```
