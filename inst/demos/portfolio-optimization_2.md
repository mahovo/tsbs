...
![](portfolio-optimization_2_files/figure-markdown_github/bootstrap_illustration-1.png)
...
```
    ...
    ## Min Variance            1.832      6.738  0.272  -20.734
    ## Max Sharpe              6.964     11.718  0.594  -23.693
    ## Risk Parity             5.662      9.256  0.612  -20.104
    ## Black-Litterman         2.917      7.077  0.412  -19.813
    ## Shrinkage               1.822      6.753  0.270  -20.766
...
```
    ...
    ## |:-----|------:|------:|--------:|--------:|--------:|
    ## |SPY   | 0.0931| 0.0521|   0.0477|   0.2423|   0.1946|
    ## |EFA   | 0.0963| 0.0584|   0.0393|   0.2437|   0.2045|
    ## |BND   | 0.5311| 0.2157|   0.0000|   0.6876|   0.6876|
    ## |GLD   | 0.1765| 0.0934|   0.0867|   0.4333|   0.3465|
    ## |VNQ   | 0.1030| 0.0770|   0.0580|   0.2984|   0.2404|
...
```
    ...
    ## |Asset |   Mean|     SD| CI_Lower| CI_Upper| CI_Width|
    ## |:-----|------:|------:|--------:|--------:|--------:|
    ## |SPY   | 0.0748| 0.0200|   0.0515|   0.1177|   0.0662|
    ## |EFA   | 0.0831| 0.0196|   0.0582|   0.1163|   0.0581|
    ## |BND   | 0.6053| 0.1190|   0.4015|   0.6823|   0.2807|
    ## |GLD   | 0.1581| 0.0663|   0.1140|   0.2729|   0.1590|
    ## |VNQ   | 0.0787| 0.0213|   0.0646|   0.1211|   0.0565|
...
```
    ...
    ## |Asset |   Mean|     SD| CI_Lower| CI_Upper| CI_Width|
    ## |:-----|------:|------:|--------:|--------:|--------:|
    ## |SPY   | 0.0694| 0.0272|   0.0306|   0.1327|   0.1022|
    ## |EFA   | 0.0822| 0.0277|   0.0345|   0.1548|   0.1204|
    ## |BND   | 0.5859| 0.1645|   0.0000|   0.6937|   0.6937|
    ## |GLD   | 0.1775| 0.0942|   0.1023|   0.4834|   0.3811|
    ## |VNQ   | 0.0850| 0.0414|   0.0537|   0.2014|   0.1477|
...
```
    ...
    ## |:-----|------:|------:|-------:|
    ## |SPY   | 0.1946| 0.0662|  0.1022|
    ## |EFA   | 0.2045| 0.0581|  0.1204|
    ## |BND   | 0.6876| 0.2807|  0.6937|
    ## |GLD   | 0.3465| 0.1590|  0.3811|
    ## |VNQ   | 0.2404| 0.0565|  0.1477|
    ## 
    ## Average CI Width by Model:
    ##   DCC: 0.3347
    ##   CGARCH: 0.1241
...
![](portfolio-optimization_2_files/figure-markdown_github/model_comparison_plot-1.png)
...
| Function | Purpose |
|--------------------------------------|----------------------------------|
| `compute_bootstrap_diagnostics()` | Create diagnostics from bootstrap output |
| `summary.tsbs_diagnostics()` | Print comprehensive summary |
| `plot.tsbs_diagnostics()` | Visualize block lengths, coverage, statistics |
| `extract_blocks()` | Extract block-level information |
| `extract_summary_stats()` | Get statistical summaries |
...
We use `compute_bootstrap_diagnostics()` to analyze how each bootstrap
method samples from the original data.
...
The `summary()` method provides a comprehensive overview of bootstrap
characteristics.
...
```
    ...
    ##   Total blocks sampled: 774 
    ##   Mean block length: 9.77 
    ##   SD block length: 1.79 
    ##   Min block length: 2 
    ##   Max block length: 20 
    ...
    ##     Variable 1 :
    ##       Original: 0.0995 
    ##       Bootstrap avg: 0.0927 
    ##       Bootstrap SD: 0.049 
    ##       Bias: -0.0069 
    ##     Variable 2 :
    ##       Original: 0.0566 
    ##       Bootstrap avg: 0.0396 
    ##       Bootstrap SD: 0.0466 
    ##       Bias: -0.017 
    ##     Variable 3 :
    ##       Original: 0.0185 
    ...
    ##     Variable 4 :
    ##       Original: 0.08 
    ##       Bootstrap avg: 0.0583 
    ##       Bootstrap SD: 0.0481 
    ##       Bias: -0.0217 
    ##     Variable 5 :
    ##       Original: 0.0171 
    ##       Bootstrap avg: 0.0132 
    ##       Bootstrap SD: 0.0896 
    ##       Bias: -0.0039 
    ## 
    ...
    ##     Variable 3 :
    ##       Original: -0.0454 
    ##       Bootstrap avg: -0.0367 
    ##       Bootstrap SD: 0.0587 
    ##     Variable 4 :
    ##       Original: -0.055 
    ##       Bootstrap avg: -0.0641 
    ##       Bootstrap SD: 0.0768 
    ##     Variable 5 :
    ##       Original: 0.0142 
    ##       Bootstrap avg: 0.0118 
    ##       Bootstrap SD: 0.0484 
    ## 
    ## ========================================
...
```
    ...
    ## 
    ## BLOCK LENGTH STATISTICS:
    ##   Total blocks sampled: 865 
    ##   Mean block length: 8.74 
    ##   SD block length: 7.16 
    ##   Min block length: 1 
    ##   Max block length: 26 
    ##   Median block length: 7 
    ##   25th percentile: 3 
    ##   75th percentile: 12 
    ##   Mean blocks per replicate: 28.83 
    ## 
    ## ORIGINAL vs BOOTSTRAP STATISTICS:
    ## 
    ##   MEANS:
    ##     Variable 1 :
    ##       Original: 0.0995 
    ##       Bootstrap avg: 0.1058 
    ##       Bootstrap SD: 0.0455 
    ##       Bias: 0.0063 
    ##     Variable 2 :
    ##       Original: 0.0566 
    ##       Bootstrap avg: 0.0533 
    ##       Bootstrap SD: 0.0478 
    ##       Bias: -0.0033 
    ##     Variable 3 :
    ##       Original: 0.0185 
    ...
    ##     Variable 4 :
    ##       Original: 0.08 
    ##       Bootstrap avg: 0.0578 
    ##       Bootstrap SD: 0.0473 
    ##       Bias: -0.0222 
    ##     Variable 5 :
    ##       Original: 0.0171 
    ##       Bootstrap avg: 0.0228 
    ##       Bootstrap SD: 0.0647 
    ##       Bias: 0.0056 
    ## 
    ##   LAG-1 AUTOCORRELATION:
    ##     Variable 1 :
    ##       Original: 0.0749 
    ##       Bootstrap avg: 0.0736 
    ##       Bootstrap SD: 0.064 
    ##     Variable 2 :
    ##       Original: 0.1013 
    ##       Bootstrap avg: 0.0903 
    ##       Bootstrap SD: 0.067 
    ##     Variable 3 :
    ##       Original: -0.0454 
    ##       Bootstrap avg: -0.0363 
    ##       Bootstrap SD: 0.0648 
    ##     Variable 4 :
    ##       Original: -0.055 
    ##       Bootstrap avg: -0.052 
...
The `plot()` method creates diagnostic visualizations. Available plot
types include:
...
![](portfolio-optimization_2_files/figure-markdown_github/plot_diagnostics_blocks-1.png)
...
![](portfolio-optimization_2_files/figure-markdown_github/plot_diagnostics_blocks-2.png)
...
![](portfolio-optimization_2_files/figure-markdown_github/plot_diagnostics_means-1.png)

``` r
plot(stationary_diag, type = "means_comparison")
```

![](portfolio-optimization_2_files/figure-markdown_github/plot_diagnostics_means-2.png)

## Extraction Functions

Use `extract_blocks()` and `extract_summary_stats()` to access
diagnostic data programmatically.
...
The `as.data.frame()` method converts diagnostics to tabular format for
further analysis.
...
```
    ...
    ## |:-------|:-----|-----:|:---------|
    ## |DCC     |SPY   | 0.560|Moderate  |
    ## |DCC     |EFA   | 0.606|Unstable  |
    ## |DCC     |BND   | 0.406|Moderate  |
    ## |DCC     |GLD   | 0.529|Moderate  |
    ## |DCC     |VNQ   | 0.748|Unstable  |
    ## |CGARCH  |SPY   | 0.268|Stable    |
    ## |CGARCH  |EFA   | 0.235|Stable    |
    ## |CGARCH  |BND   | 0.197|Stable    |
    ## |CGARCH  |GLD   | 0.420|Moderate  |
    ## |CGARCH  |VNQ   | 0.271|Stable    |
    ## |GOGARCH |SPY   | 0.392|Moderate  |
    ## |GOGARCH |EFA   | 0.337|Moderate  |
    ## |GOGARCH |BND   | 0.281|Stable    |
    ## |GOGARCH |GLD   | 0.530|Moderate  |
    ## |GOGARCH |VNQ   | 0.488|Moderate  |
    ## 
    ## Stability Summary by Model:
    ##   DCC: Mean CV = 0.570, 0 Stable, 3 Moderate, 2 Unstable
    ##   CGARCH: Mean CV = 0.278, 4 Stable, 1 Moderate, 0 Unstable
    ##   GOGARCH: Mean CV = 0.406, 1 Stable, 4 Moderate, 0 Unstable
    ## 
    ## Interpretation:
...
![](portfolio-optimization_2_files/figure-markdown_github/cumulative_returns-1.png)
...
![](portfolio-optimization_2_files/figure-markdown_github/rolling_sharpe-1.png)
...
![](portfolio-optimization_2_files/figure-markdown_github/weight_evolution-1.png)
...
![](portfolio-optimization_2_files/figure-markdown_github/weight_evolution-2.png)
...
```
    ...
    ##   Ann_Return: Median=19.66, 95% CI=[16.04, 46.19]
    ##   Ann_Vol: Median=3.09, 95% CI=[2.83, 7.43]
    ##   Sharpe: Median=6.26, 95% CI=[5.22, 7.03]
    ## 
    ## CGARCH Performance Distribution:
    ##   Ann_Return: Median=18.98, 95% CI=[16.38, 24.63]
    ##   Ann_Vol: Median=3.00, 95% CI=[2.80, 4.20]
    ##   Sharpe: Median=6.32, 95% CI=[5.28, 7.06]
    ## 
    ## GOGARCH Performance Distribution:
    ##   Ann_Return: Median=18.53, 95% CI=[15.49, 29.84]
    ##   Ann_Vol: Median=3.05, 95% CI=[2.83, 6.54]
    ##   Sharpe: Median=5.90, 95% CI=[4.37, 7.47]
...
![](portfolio-optimization_2_files/figure-markdown_github/performance_uncertainty-1.png)
...
```
    ...
    ## |:-----|-----:|---------:|-----------:|----------:|------------:|
    ## |SPY   | 0.069|     0.093|       0.079|      0.082|        0.074|
    ## |EFA   | 0.080|     0.096|       0.084|      0.085|        0.084|
    ## |BND   | 0.627|     0.531|       0.609|      0.579|        0.619|
    ## |GLD   | 0.153|     0.176|       0.158|      0.157|        0.149|
    ## |VNQ   | 0.071|     0.103|       0.075|      0.084|        0.075|
    ## 
    ## --- CGARCH Model ---
    ## 
    ## 
    ## |Asset | Point| Boot_Mean| Boot_Median| Winsorized| Conservative|
    ## |:-----|-----:|---------:|-----------:|----------:|------------:|
    ## |SPY   | 0.069|     0.075|       0.070|      0.072|        0.066|
    ## |EFA   | 0.080|     0.083|       0.082|      0.082|        0.079|
    ## |BND   | 0.627|     0.605|       0.623|      0.625|        0.637|
    ## |GLD   | 0.153|     0.158|       0.146|      0.147|        0.145|
    ## |VNQ   | 0.071|     0.079|       0.073|      0.075|        0.074|
    ## 
    ## --- GOGARCH Model ---
    ## 
    ## 
    ## |Asset | Point| Boot_Mean| Boot_Median| Winsorized| Conservative|
    ## |:-----|-----:|---------:|-----------:|----------:|------------:|
    ## |SPY   | 0.069|     0.069|       0.064|      0.067|        0.059|
    ## |EFA   | 0.080|     0.082|       0.083|      0.081|        0.076|
    ## |BND   | 0.627|     0.586|       0.624|      0.623|        0.648|
    ## |GLD   | 0.153|     0.178|       0.156|      0.156|        0.151|
    ## |VNQ   | 0.071|     0.085|       0.074|      0.075|        0.066|
    ## 
    ## --- Cross-Model Comparison (Bootstrap Means) ---
    ## 
    ## 
    ...
    ## |:-----|-----:|-----:|------:|-------:|
    ## |SPY   | 0.069| 0.093|  0.075|   0.069|
    ## |EFA   | 0.080| 0.096|  0.083|   0.082|
    ## |BND   | 0.627| 0.531|  0.605|   0.586|
    ## |GLD   | 0.153| 0.176|  0.158|   0.178|
    ## |VNQ   | 0.071| 0.103|  0.079|   0.085|
    ## 
    ## The bootstrap means across models are generally consistent, suggesting
...
```
    ...
    ## |Min Variance    |       0.0925|9.3%         |
    ## |Max Sharpe      |       0.6627|66.3%        |
    ## |Risk Parity     |       0.0854|8.5%         |
    ## |Black-Litterman |       0.1233|12.3%        |
    ## |Shrinkage       |       0.0941|9.4%         |
...
```
    ...
    ## |Min Variance.Min Variance       |      0.272|         0.266|     -0.005|
    ## |Max Sharpe.Max Sharpe           |      0.594|         0.572|     -0.023|
    ## |Risk Parity.Risk Parity         |      0.612|         0.608|     -0.004|
    ## |Black-Litterman.Black-Litterman |      0.412|         0.405|     -0.007|
    ## |Shrinkage.Shrinkage             |      0.270|         0.264|     -0.006|
...
```
    ...
    ## |:---------------|-----------:|--------:|-----------:|----------:|--------:|
    ## |Risk Parity     |           3|        4|           2|          2|     2.75|
    ## |Black-Litterman |           4|        3|           4|          1|     3.00|
    ## |Equal Weight    |           1|        6|           1|          6|     3.50|
    ## |Min Variance    |           5|        1|           5|          3|     3.50|
    ## |Max Sharpe      |           2|        5|           3|          5|     3.75|
    ## |Shrinkage       |           6|        2|           6|          4|     4.50|
...
-   The averaged weights may be more robust than the single-sample
    optimum
...
```
    ...
    ## 
    ## Completed 5 of 6 bootstrap methods.
    ...
    ## |Asset | Point| Boot_Mean| Boot_SD| CI_Width|
    ## |:-----|-----:|---------:|-------:|--------:|
    ## |SPY   | 0.069|     0.072|   0.015|    0.054|
    ## |EFA   | 0.080|     0.080|   0.020|    0.066|
    ## |BND   | 0.627|     0.621|   0.037|    0.121|
    ## |GLD   | 0.153|     0.154|   0.019|    0.067|
    ## |VNQ   | 0.071|     0.074|   0.011|    0.039|
    ## 
    ## --- Wild ---
    ## 
    ## 
    ...
    ## 
    ## 
    ## |Asset | Point| Plain (iid)| Moving Block| Stationary| MS-VARMA-GARCH|  Wild|
    ## |:-----|-----:|-----------:|------------:|----------:|--------------:|-----:|
    ## |SPY   | 0.069|        0.07|        0.068|      0.071|          0.072| 0.069|
    ## |EFA   | 0.080|        0.08|        0.079|      0.082|          0.080| 0.080|
    ## |BND   | 0.627|        0.63|        0.634|      0.622|          0.621| 0.628|
    ## |GLD   | 0.153|        0.15|        0.149|      0.153|          0.154| 0.153|
    ## |VNQ   | 0.071|        0.07|        0.070|      0.071|          0.074| 0.071|
    ## 
    ## -----------------------------------------------------------------------
...
![](portfolio-optimization_2_files/figure-markdown_github/bootstrap_comparison_plot-1.png)
...
The `benchmark_tsbs()` utility allows systematic comparison of runtime
across methods as we vary parameters like the number of bootstrap
replicates. This helps in choosing an appropriate method given time
constraints.
...
```
    ...
    ## [74/105] HMM: num_boots = 64 (rep 2/3)    converged at iteration 36 with logLik: -1084.145 
    ## [75/105] HMM: num_boots = 64 (rep 3/3)    converged at iteration 36 with logLik: -1084.145 
    ## [76/105] HMM: num_boots = 128 (rep 1/3)    converged at iteration 35 with logLik: -1084.145 
    ## [77/105] HMM: num_boots = 128 (rep 2/3)    converged at iteration 29 with logLik: -1084.145 
    ## [78/105] HMM: num_boots = 128 (rep 3/3)    converged at iteration 34 with logLik: -1084.145 
    ## [79/105] HMM: num_boots = 256 (rep 1/3)    converged at iteration 41 with logLik: -1084.145 
    ## [80/105] HMM: num_boots = 256 (rep 2/3)    converged at iteration 34 with logLik: -1084.145 
    ## [81/105] HMM: num_boots = 256 (rep 3/3)    converged at iteration 38 with logLik: -1084.145 
    ## [82/105] HMM: num_boots = 512 (rep 1/3)    converged at iteration 34 with logLik: -1084.145 
    ## [83/105] HMM: num_boots = 512 (rep 2/3)    converged at iteration 34 with logLik: -1084.145 
    ## [84/105] HMM: num_boots = 512 (rep 3/3)    converged at iteration 35 with logLik: -1084.145 
...
```
    ...
    ##      8 0.0981     0.000293    0.000304   0.000310 0.00136
    ##     16 0.0497     0.001890    0.000478   0.000471 0.00174
    ##     32 0.0522     0.001290    0.000852   0.000844 0.00289
    ##     64 0.0674     0.001894    0.001643   0.002974 0.00537
    ##    128 0.0970     0.003021    0.005452   0.003898 0.01018
    ##    256 0.1346     0.008012    0.006260   0.014749 0.02127
    ##    512 0.2509     0.014253    0.014945   0.016220 0.03770

![](portfolio-optimization_2_files/figure-markdown_github/benchmark_run-1.png)
...
```
    ...
    ## [53/75] HMM: n_boot = 256 (rep 2/3)    converged at iteration 35 with logLik: -1084.145 
    ## [54/75] HMM: n_boot = 256 (rep 3/3)    converged at iteration 36 with logLik: -1084.145 
    ## [55/75] HMM: n_boot = 512 (rep 1/3)    converged at iteration 34 with logLik: -1084.145 
    ## [56/75] HMM: n_boot = 512 (rep 2/3)    converged at iteration 36 with logLik: -1084.145 
    ## [57/75] HMM: n_boot = 512 (rep 3/3)    converged at iteration 27 with logLik: -1084.145 
    ## [58/75] HMM: n_boot = 1024 (rep 1/3)    converged at iteration 34 with logLik: -1084.145 
    ## [59/75] HMM: n_boot = 1024 (rep 2/3)    converged at iteration 31 with logLik: -1084.145 
...
```
    ...
    ## 
    ##  Value    HMM Moving Block Plain (iid) Stationary    Wild
    ##     64 0.0551      0.00167     0.00178    0.00171 0.00864
    ##    128 0.0545      0.00190     0.00198    0.00199 0.00770
    ##    256 0.0711      0.00312     0.00239    0.00243 0.00873
    ##    512 0.1018      0.00779     0.00428    0.00435 0.00746
    ##   1024 0.2033      0.00560     0.00670    0.00644 0.00755

![](portfolio-optimization_2_files/figure-markdown_github/benchmark_run_nboot-1.png)
...
```
    ...
    ## [1/90] Plain (iid): n_assets = 4 (rep 1/3)    [2/90] Plain (iid): n_assets = 4 (rep 2/3)    [3/90] Plain (iid): n_assets = 4 (rep 3/3)    [4/90] Plain (iid): n_assets = 8 (rep 1/3)    [5/90] Plain (iid): n_assets = 8 (rep 2/3)    [6/90] Plain (iid): n_assets = 8 (rep 3/3)    [7/90] Plain (iid): n_assets = 16 (rep 1/3)    [8/90] Plain (iid): n_assets = 16 (rep 2/3)    [9/90] Plain (iid): n_assets = 16 (rep 3/3)    [10/90] Plain (iid): n_assets = 32 (rep 1/3)    [11/90] Plain (iid): n_assets = 32 (rep 2/3)    [12/90] Plain (iid): n_assets = 32 (rep 3/3)    [13/90] Plain (iid): n_assets = 64 (rep 1/3)    [14/90] Plain (iid): n_assets = 64 (rep 2/3)    [15/90] Plain (iid): n_assets = 64 (rep 3/3)    [16/90] Plain (iid): n_assets = 128 (rep 1/3)    [17/90] Plain (iid): n_assets = 128 (rep 2/3)    [18/90] Plain (iid): n_assets = 128 (rep 3/3)    [19/90] Moving Block: n_assets = 4 (rep 1/3)    [20/90] Moving Block: n_assets = 4 (rep 2/3)    [21/90] Moving Block: n_assets = 4 (rep 3/3)    [22/90] Moving Block: n_assets = 8 (rep 1/3)    [23/90] Moving Block: n_assets = 8 (rep 2/3)    [24/90] Moving Block: n_assets = 8 (rep 3/3)    [25/90] Moving Block: n_assets = 16 (rep 1/3)    [26/90] Moving Block: n_assets = 16 (rep 2/3)    [27/90] Moving Block: n_assets = 16 (rep 3/3)    [28/90] Moving Block: n_assets = 32 (rep 1/3)    [29/90] Moving Block: n_assets = 32 (rep 2/3)    [30/90] Moving Block: n_assets = 32 (rep 3/3)    [31/90] Moving Block: n_assets = 64 (rep 1/3)    [32/90] Moving Block: n_assets = 64 (rep 2/3)    [33/90] Moving Block: n_assets = 64 (rep 3/3)    [34/90] Moving Block: n_assets = 128 (rep 1/3)    [35/90] Moving Block: n_assets = 128 (rep 2/3)    [36/90] Moving Block: n_assets = 128 (rep 3/3)    [37/90] Stationary: n_assets = 4 (rep 1/3)    [38/90] Stationary: n_assets = 4 (rep 2/3)    [39/90] Stationary: n_assets = 4 (rep 3/3)    [40/90] Stationary: n_assets = 8 (rep 1/3)    [41/90] Stationary: n_assets = 8 (rep 2/3)    [42/90] Stationary: n_assets = 8 (rep 3/3)    [43/90] Stationary: n_assets = 16 (rep 1/3)    [44/90] Stationary: n_assets = 16 (rep 2/3)    [45/90] Stationary: n_assets = 16 (rep 3/3)    [46/90] Stationary: n_assets = 32 (rep 1/3)    [47/90] Stationary: n_assets = 32 (rep 2/3)    [48/90] Stationary: n_assets = 32 (rep 3/3)    [49/90] Stationary: n_assets = 64 (rep 1/3)    [50/90] Stationary: n_assets = 64 (rep 2/3)    [51/90] Stationary: n_assets = 64 (rep 3/3)    [52/90] Stationary: n_assets = 128 (rep 1/3)    [53/90] Stationary: n_assets = 128 (rep 2/3)    [54/90] Stationary: n_assets = 128 (rep 3/3)    [55/90] HMM: n_assets = 4 (rep 1/3)    converged at iteration 227 with logLik: -1402.811 
    ## [56/90] HMM: n_assets = 4 (rep 2/3)    converged at iteration 224 with logLik: -1402.811 
    ## [57/90] HMM: n_assets = 4 (rep 3/3)    converged at iteration 229 with logLik: -1402.811 
    ## [58/90] HMM: n_assets = 8 (rep 1/3)    converged at iteration 160 with logLik: -2798.372 
    ## [59/90] HMM: n_assets = 8 (rep 2/3)    converged at iteration 165 with logLik: -2798.372 
    ## [60/90] HMM: n_assets = 8 (rep 3/3)    converged at iteration 161 with logLik: -2798.372 
    ## [61/90] HMM: n_assets = 16 (rep 1/3)    converged at iteration 123 with logLik: -5617.018 
    ## [62/90] HMM: n_assets = 16 (rep 2/3)    converged at iteration 41 with logLik: -5617.017 
    ## [63/90] HMM: n_assets = 16 (rep 3/3)    converged at iteration 59 with logLik: -5619.896 
    ## [64/90] HMM: n_assets = 32 (rep 1/3)    converged at iteration 89 with logLik: -11260.84 
    ## [65/90] HMM: n_assets = 32 (rep 2/3)    converged at iteration 94 with logLik: -11260.84 
    ## [66/90] HMM: n_assets = 32 (rep 3/3)    converged at iteration 82 with logLik: -11264.74 
    ## [67/90] HMM: n_assets = 64 (rep 1/3)    converged at iteration 133 with logLik: -22597.75 
    ## [68/90] HMM: n_assets = 64 (rep 2/3)    converged at iteration 62 with logLik: -22599.22 
    ## [69/90] HMM: n_assets = 64 (rep 3/3)    converged at iteration 120 with logLik: -22596.58 
    ## [70/90] HMM: n_assets = 128 (rep 1/3)    converged at iteration 212 with logLik: -45300.03 
    ## [71/90] HMM: n_assets = 128 (rep 2/3)    converged at iteration 52 with logLik: -45315.35 
    ## [72/90] HMM: n_assets = 128 (rep 3/3)    converged at iteration 149 with logLik: -45297.39 
...
```
    ...
    ## 
    ##  Value   HMM Moving Block Plain (iid) Stationary    Wild
    ##      4 0.214      0.00202     0.00229    0.00219 0.00733
    ##      8 0.297      0.00324     0.00484    0.00422 0.01022
    ##     16 0.323      0.00741     0.04501    0.00628 0.01072
    ##     32 0.527      0.01018     0.01187    0.01198 0.01844
    ##     64 1.274      0.05782     0.02661    0.06010 0.02886
    ##    128 3.062      0.04404     0.12702    0.07798 0.11767

![](portfolio-optimization_2_files/figure-markdown_github/benchmark_run_nassets-1.png)
...
data, we use `plot_regime_composition()` from the diagnostics system.
For regime-switching methods (HMM, MS-VARMA-GARCH), we can overlay
smoothed state probabilities to show regime uncertainty.
...
![](portfolio-optimization_2_files/figure-markdown_github/regime_composition_plots-1.png)
...
2.  **Bootstrap diagnostics system**: The `tsbs` package’s
    ...
    -   `compute_bootstrap_diagnostics()` for post-hoc analysis
    -   `summary()` and `plot()` methods for visualization
    -   `extract_blocks()` and `extract_summary_stats()` for
        programmatic access
...
6.  **Composition visualization**: `plot_regime_composition()` reveals
    how each method samples from the original data, helping users
    understand the implications of their method choice.

7.  **Runtime considerations**: The `benchmark_tsbs()` utility helps
    choose methods based on computational constraints.

For more details on the underlying models, see: - `?tsbs` for the main
bootstrap interface - `?compute_bootstrap_diagnostics` for the
diagnostics system - `?plot.tsbs_diagnostics` for diagnostic
visualization - `?extract_blocks` and `?extract_summary_stats` for data
extraction - `?benchmark_tsbs` for runtime benchmarking
    ...
    ## 
    ## Vignette completed at: 2026-01-31 09:35:35
